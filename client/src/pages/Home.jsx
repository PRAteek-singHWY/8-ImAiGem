...
const RenderCards = ({ data, title }) => {
  ...
  return <h2 className="mt-5 font-bold text-[#F59E0B] text-xl uppercase">{title}</h2>
  ...
  return (
    ...
    <section className="max-w-7xl mx-auto" >
      <div>
        ...
        <p className="mt-2 text-[#596e80] text-[16px] max-w-[500px]  ">Browse Through a Collection of imgiantive and Visually stunnig Images by openaApi's DALL.E 2</p>
      </div>
      {/* Form field */}
      <div className="mt-16" >
        <FormField
          ...
          (<>
            {searchText &&
              <h2 className="font-medium text-2xl text-[#F59E0B]">
                Showing results for <span className="text-[#F59E0B]">
                  {searchText}
                </span>
              </h2>
            }
