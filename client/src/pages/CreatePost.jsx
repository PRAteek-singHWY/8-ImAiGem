  ...
  return (
    ...
    <section className="max-w-7xl mx-auto">
      <div>
        ...
        <p className="mt-2 text-[#687784] text-[16px] max-w-[500px]  ">Create imaginative and visually stunning images through OpenAI's DALL·E 2 and share them with the community</p>
      </div>
...
"
        ...
        <div className="mt-10" >
          <p className="pt-3 pb-3 text-gray-400 " >Once created you can ShowCase Your
            AweSome creation in the Community</p>
          <button
            type="submit"
